(() => {
    ...
    function initSliders() {
        if (document.querySelector(".first-block-top__slider")) new core(".first-block-top__slider", {
            modules: [ Pagination, Parallax, Keyboard ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            spaceBetween: 500,
            ...
            parallax: true,
            pagination: {
                el: ".first-block-top__control .first-block-top__pagination",
                clickable: true
            },
            keyboard: {
                enabled: true,
            ...
            on: {
                init: function(swiper) {
                    const allSlides = document.querySelector(".first-block-top__fraction_all");
                    const allSlidesItems = document.querySelectorAll(".first-block-top__slide:not(.swiper-slide-duplicate)");
                    allSlides.innerHTML = allSlidesItems.length < 10 ? `0${allSlidesItems.length}` : allSlidesItems.length;
                },
                slideChange: function(swiper) {
                    const currentSlide = document.querySelector(".first-block-top__fraction_current");
    ...
    const menuBlocks = document.querySelectorAll(".sub-catalog_group");
    if (menuBlocks.length) menuBlocks.forEach((menuBlock => {
        const menuBlockItems = menuBlock.querySelectorAll(".sub-catalog__title").length;
        menuBlock.classList.add(`sub-catalog__group_${menuBlockItems}`);
    }));
    function documentActions(e) {
        ...
        if (targetElement.closest(".header-top-block__catalog-menulink")) {
            document.documentElement.classList.add("catalog-open");
            e.preventDefault();
        }
        if (targetElement.closest(".catalog__backlink")) {
            document.documentElement.classList.remove("catalog-open");
            document.querySelector("._sub-menu-active") ? document.querySelector("._sub-menu-active").classList.remove("_sub-menu-active") : null;
            document.querySelector("._sub-menu-open") ? document.querySelector("._sub-menu-open").classList.remove("_sub-menu-open") : null;
            e.preventDefault();
        }
        if (targetElement.closest(".sub-catalog__backlink")) {
            document.documentElement.classList.remove("sub-menu-open");
            document.querySelector("._sub-menu-active") ? document.querySelector("._sub-menu-active").classList.remove("_sub-menu-active") : null;
            document.querySelector("._sub-menu-open") ? document.querySelector("._sub-menu-open").classList.remove("_sub-menu-open") : null;
            e.preventDefault();
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            const targetElement = e.target;
            if (targetElement.classList.contains("header-top-block__icon-search")) document.querySelector(".header-middle-block__form").classList.toggle("_active-search"); else if (!targetElement.closest(".header-middle-block__form") && document.querySelector(".header-middle-block__form._active-search")) document.querySelector(".header-middle-block__form").classList.remove("_active-search");
        }
    };
    window["FLS"] = true;
    isWebp();
